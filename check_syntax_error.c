...
/**
 * repeated_char - It counts the ripitions of a character
 *
 * @input: enter string
 * @i: index
 * Return: repetitions
 ...
 * Return: Index of error. 0 if there are no errors
 */
...
/**
 * print_syntax_error - prints ehen ther is a syntax error
 *
 * @input: input string.
